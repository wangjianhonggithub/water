...
use app\admin\model\Servicecommitment;
use think\Request;
use think\Loader;
use think\Db;
...
class Product extends Base
{
    ...
    {
        $servicecommitment = new Servicecommitment();
        $rs = $servicecommitment->getAll();
        $this->assign('rs',$rs);
        return $this->fetch('Product/Servicecommitment');
    }

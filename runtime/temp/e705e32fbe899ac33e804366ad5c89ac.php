<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/default/ankeman/public/../application/admin/view/Question/update.html";i:1563941999;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="title" placeholder="标题" value="<?php echo $quest['title']; ?>" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="content" placeholder="回答" value="<?php echo $quest['content']; ?>" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>

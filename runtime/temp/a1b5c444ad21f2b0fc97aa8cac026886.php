<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\servicex\index.html";i:1567671858;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div id="demo-custom-toolbar2" class="table-toolbar-left">
        <a href="/Admin/ServicexAdd" id="demo-dt-addrow-btn" class="btn btn-primary"><i class="demo-pli-plus"></i> 添加</a>
        <div class="col-m-5">
        </div>
    </div>
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td><img src="__ROOT__<?php echo $vo['img']; ?>"></td>
                <td><?php echo date("Y-m-d",$vo['addtime']); ?></td>
                <td>
                    <a href="/Admin/ServicexDetails?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (data.code == 1) {
                        ...
                        setTimeout(function(){
                            window.location.href='/Admin/Servicex'
                        },1500);
                    }else{
                        layer.msg(data.meg, function(){
                            //关闭后的操作

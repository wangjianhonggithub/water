<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\servicex\details.html";i:1568712046;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="tab-content">
                ...
                <div id="demo-tabs-box-1" class="tab-pane fade in active">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="title" placeholder="标题" data-bv-field="name" value="<?php echo $rs['title']; ?>">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-4">
                            <img src="<?php echo $rs['img']; ?>" alt="" style="width: 150px;height: 120px;">
                        </div>
                    </div>
                    <div class="form-group has-feedback">
                    ...
                    <div id="demo-tabs-box-1" class="tab-pane fade in active">
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-lg-4">
                                <textarea id="content" name="content"><?php echo $rs['content']; ?></textarea>
                            </div>
                        </div>
                    </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/home/wwwroot/default/ankeman/public/../application/admin/view/Product/Serviceflow.html";i:1563941998;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div class="form-group has-feedback">
                    <label class="col-lg-3 control-label">流程<?php echo $vo['id']; ?>：</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" name="flow<?php echo $vo['id']; ?>" value="<?php echo $vo['content']; ?>" placeholder="" data-bv-field="name">

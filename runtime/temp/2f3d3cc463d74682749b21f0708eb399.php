<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Service\add_nav.html";i:1567671860;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="title" placeholder="分类" data-bv-field="name">

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Menu/update.html";i:1563947915;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <!--===================================================-->
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="menu" value="<?php echo $rs['menu']; ?>" placeholder="" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="display" value="<?php echo $rs['display']; ?>" placeholder="" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="email" class="form-control" name="url" value="<?php echo $rs['url']; ?>" placeholder="" data-bv-field="name">
        ...
        <div class="form-group has-feedback">
          ...
          <div class="col-lg-7">
            <input type="email" class="form-control" name="status" value="<?php echo $rs['status']; ?>" placeholder="" data-bv-field="name">
            <i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
          </div>
        </div>
        </div>

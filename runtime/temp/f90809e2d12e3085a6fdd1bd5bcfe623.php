<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Project\add.html";i:1567671856;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567671859;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="title" placeholder="导航" data-bv-field="name">

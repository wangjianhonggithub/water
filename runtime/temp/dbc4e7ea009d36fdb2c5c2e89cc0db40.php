<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/wwwroot/default/ankeman/public/../application/index/view/index/index.html";i:1567670854;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="service-top">
					<div class="service-box">
						<div class="service-top-item-a p-r">
							<div class="top-item-name">室内空气治理</div>
							<div class="top-item-text">纯进口产品13年高品质除甲醛服务</div>
						</div>
					</div>
					<div class="service-box">
						<div class="service-top-item-b p-r p-l">
							<div class="top-item-name">车内空气治理</div>
							<div class="top-item-text">纯进口产品13年高品质除甲醛服务</div>
						</div>
					</div>
					<div class="service-box">
						<div class="service-top-item-c p-r p-l">
							<div class="top-item-name">室内空气污染检测</div>
							<div class="top-item-text">纯进口产品13年高品质除甲醛服务 拷贝</div>
						</div>
					</div>
					<div class="service-box">
						<div class="service-top-item-d p-l">
							<div class="top-item-name">空调清洗</div>
							<div class="top-item-text">10年专业工程师</div>
						</div>
					</div>
				</div>
				...
				<div class="service-bot">
					<div class="service-box">
						<div class="service-bot-item p-r">
							<div class="service-bot-left">
								<div class="bot-item-name">专业除甲醛</div>
								<div class="bot-item-text">保持良好的生活空间</div>
							</div>
					...
					<div class="service-box">
						<div class="service-bot-item p-r p-l">
							<div class="service-bot-left">
								<div class="bot-item-name">专业除异味</div>
								<div class="bot-item-text">除味长期质保不反弹</div>
							</div>
					...
					<div class="service-box">
						<div class="service-bot-item p-r p-l">
							<div class="service-bot-left">
								<div class="bot-item-name">专业除TVOC</div>
								<div class="bot-item-text">10年经验治理工程师</div>
							</div>
					...
					<div class="service-box">
						<div class="service-bot-item p-l">
							<div class="service-bot-left">
								<div class="bot-item-name">中央空调清洗</div>
								<div class="bot-item-text">24小时响应服务</div>
							</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/home/wwwroot/default/ankeman/public/../application/admin/view/Project/details_update.html";i:1563941998;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
  ...
  <input type="hidden" name="id" value="<?php echo $project_con['id']; ?>">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
			...
			<div class="col-lg-7">
			  <input type="text" class="form-control" name="title" placeholder="分类" disabled value="<?php echo $project['title']; ?>" data-bv-field="name" >
			  ...
			  <div class="form-group has-feedback">
				...
				<div class="col-lg-7">
				  <input type="text" class="form-control" name="title" placeholder="标题" data-bv-field="name" value="<?php echo $project_con['title']; ?>">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			  </div>
			  <div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <img src="<?php echo $project_con['img']; ?>" alt="" style="width: 150px;height: 120px;">
				</div>
			  </div>
			<div class="form-group has-feedback">
				<label class="col-lg-3 control-label">上传缩略图(图片尺寸300*200)</label>
				<div class="col-lg-4">
			...
			<div id="demo-tabs-box-1" class="tab-pane fade in active">
				<div class="form-group has-feedback">
				    ...
				    <div class="col-lg-4">
					    <script id="content" name="content" type="text/plain"><?php echo $project_con['content']; ?></script>
				    </div>
				</div> 
		    </div>
...
<script>
  $(function(){
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Project/details_DoUpdate',
          data:formData,
          contentType: false,
          processData: false,

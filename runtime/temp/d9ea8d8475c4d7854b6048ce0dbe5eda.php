<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\servicex\add.html";i:1568876263;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div class="panel-heading">
        ...
        <h3 class="panel-title">服务项目123</h3></div>
    <!-- Panel body -->
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div id="demo-tabs-box-1" class="tab-pane fade in active">
                    ...
                    <div class="form-group has-feedback">
                        <label class="col-lg-3 control-label">上传图片(图片尺寸：400*420)</label>
                        <div class="col-lg-4">

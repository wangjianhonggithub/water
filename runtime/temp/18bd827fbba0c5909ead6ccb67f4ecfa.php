<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\PHPTutorial\WWW\ankeman\public/../application/index\view\index\product.html";i:1567738739;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="box">
				...
				<div class="promise">
					<div class="promise-item-a">
						<div class="promise-text-a">
							<if condition="isset($data[0])">
								<?php echo $data[0]['content']; ?>
							</if>
						</div>
						<div class="promise-text-b">
							<if condition="isset($data[1])">
								<span><?php echo $data[1]['content']; ?></span>
							</if>
						</div>
					</div>
					<div class="promise-item-b">
						<div class="promise-text-c">
							<if condition="isset($data[2])">
								<span><?php echo $data[2]['content']; ?></span>
							</if>
						</div>
					</div>
					<div class="clear"></div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/home/wwwroot/default/ankeman/public/../application/admin/view/Menu/add.html";i:1563941997;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563947650;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
  ...
  <div class="panel-heading">
    ...
    <h3 class="panel-title">添加导航(暂未开发)</h3></div>
  <!-- Panel body -->
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="name" placeholder="" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="icon" placeholder="" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="email" class="form-control" name="url" placeholder="" data-bv-field="email">

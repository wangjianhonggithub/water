<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Service\add.html";i:1568876242;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
  ...
  <div class="panel-heading">
    ...
    <h3 class="panel-title">服务范围</h3></div>
  <!-- Panel body -->
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
			<div class="form-group has-feedback">				
				...
				<div class="col-lg-7">					
					<select class="selectpicker col-lg-6" name="sid" data-live-search="true" data-width="100%" tabindex="-98">						

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Column\update.html";i:1567671858;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal FormAction bv-form" action="/Admin/Column/DoAdd" method="POST" novalidate="novalidate">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
                 <select class="selectpicker col-lg-6" id="SelectVal" name="pid" data-live-search="true" data-width="100%" tabindex="-98">
        			    ...
        			    <option value="<?php echo $val['id']; ?>" <?php if($val['id'] == $update['pid']){echo 'selected';} ?>><?php if ($val['lev'] != 1) {echo str_repeat("&nbsp",4*$val['lev']);}?><?php echo $val['name']; ?></option>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="name" value="<?php echo $update['name']; ?>" placeholder="Name" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="icon" value="<?php echo $update['icon']; ?>" placeholder="ICON" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="email" class="form-control" name="url" value="<?php echo $update['url']; ?>" placeholder="Email" data-bv-field="email">
    ...
    <div class="panel-footer clearfix">
      <div class="col-lg-7 col-lg-offset-3">
        <button type="button" class="btn btn-mint" id="UpdateSubmit" value="点击创建">点击创建</button></div>
    </div>
  </form>
</div>
<script>
  $(function(){
      $('#UpdateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url: '/Admin/Column/DoUpdate?id=<?php echo $update['id']; ?>',
          data: {
            name:name,
            icon:icon,
            url:url,

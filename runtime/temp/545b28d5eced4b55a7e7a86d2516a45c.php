<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Column\index.html";i:1567671857;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><?php if($vo['lev'] != 1){echo str_repeat("-",4*$vo['lev']);}?><?php echo $vo['name']; ?></td>
                    <td><?php echo $vo['url']; ?></td>
                    <td><?php echo $vo['icon']; ?></td>
                    <td><?php echo $vo['create_time']; ?></td>
                    <td><?php echo $vo['update_time']; ?></td>
                    <td>
                        <a href="/Admin/Column/update/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
                        <a data-id="<?php echo $vo['id']; ?>" href="javascript:;" class="btn DeleteSubmit btn-xs btn-rounded btn-danger">删除</a>
                    </td>
                </tr>

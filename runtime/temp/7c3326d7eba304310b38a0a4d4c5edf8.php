<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/default/ankeman/public/../application/admin/view/Menu/index.html";i:1563941997;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <?php if($vo['status'] == '0'): ?> 隐藏 <?php else: ?> 显示<?php endif; ?>
                </td>
                <td>
                    <a href="/Admin/Menu/update/id/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>

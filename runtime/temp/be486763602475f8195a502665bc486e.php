<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Product\Productadvantage.html";i:1567671857;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div class="form-group has-feedback">
                    <label class="col-lg-3 control-label">优势<?php echo $vo['id']; ?>：</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" name="advantage<?php echo $vo['id']; ?>" value="<?php echo $vo['content']; ?>" placeholder="" data-bv-field="name">

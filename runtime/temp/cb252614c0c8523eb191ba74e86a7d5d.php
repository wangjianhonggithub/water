<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\About\details.html";i:1567671859;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <!--===================================================-->
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="tel" value="<?php echo $details['tel']; ?>" placeholder="电话" data-bv-field="name">
			...
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="phone" value="<?php echo $details['phone']; ?>" placeholder="座机" data-bv-field="name">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			</div>
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="email" value="<?php echo $details['email']; ?>" placeholder="邮箱" data-bv-field="name">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			</div>
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="address" value="<?php echo $details['address']; ?>" placeholder="地址" data-bv-field="name">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			</div>
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="reporting_tel" value="<?php echo $details['reporting_tel']; ?>" placeholder="电话" data-bv-field="name">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			</div>
			<div class="form-group has-feedback">
				<label class="col-lg-3 control-label">举报邮箱</label>
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="reporting_email" value="<?php echo $details['reporting_email']; ?>" placeholder="举报邮箱" data-bv-field="name">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			</div>
...
<script>
  $(function(){
      $('#CreateSubmit').click(function(){
		...
		var reporting_tel = $("input[name='reporting_tel']").val();
		var reporting_email = $("input[name='reporting_email']").val();
        $.ajax({
          type: 'POST',
          url: '/Admin/Aboult/edit',
          data: {
			id:id,
            tel:tel,
            phone:phone,
          ...
          success: function(data){
              ...
              if (data.code == 1) {
                  ...
                  setTimeout(function(){
                    window.location.href='/Admin/aboult';
                  },1500);
              }else{
                  layer.msg(data.meg, function(){
                    //关闭后的操作
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <?php if($eal['id'] == 22) {echo '<li><a href="/Admin/Productadvantage">产品优势</a></li>';} if($eal['id'] == 22) {echo '<li><a href="/Admin/Servicestandards">服务标准</a></li>';} if($eal['id'] == 22) {echo '<li><a href="/Admin/Servicecommitment">服务承诺</a></li>';} if($eal['id'] == 22) {echo '<li><a href="/Admin/Serviceflow">服务流程</a></li>';} ?>
                                        </ul>
                                        <?php } ?>
                                    </li>

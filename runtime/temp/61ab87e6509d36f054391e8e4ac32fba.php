<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/home/wwwroot/default/ankeman/public/../application/admin/view/servicex/add.html";i:1563947520;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div class="panel-heading">
        ...
        <h3 class="panel-title">服务项目</h3></div>
    <!-- Panel body -->
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div id="demo-tabs-box-1" class="tab-pane fade in active">
                    ...
                    <div class="form-group has-feedback">
                        <label class="col-lg-3 control-label">归属范围</label>
                        <div class="col-lg-7">
                            <select class="selectpicker col-lg-6"  name="sid" data-live-search="true" data-width="100%" tabindex="-98">
                                ...
                                <option value="<?php echo $vo['id']; ?>" class="selsid"><?php echo $vo['title']; ?></option>

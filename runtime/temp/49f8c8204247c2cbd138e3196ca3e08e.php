<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/default/ankeman/public/../application/admin/view/Advantage/update.html";i:1563941994;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <!--===================================================-->
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="title" value="<?php echo $con['title']; ?>" placeholder="标题" data-bv-field="name">
			...
			<div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <input type="text" class="form-control" name="content" value="<?php echo $con['content']; ?>" placeholder="内容" data-bv-field="name">
				  <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
				</div>
			</div>

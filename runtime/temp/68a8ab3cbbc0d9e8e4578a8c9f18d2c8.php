<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/home/wwwroot/default/ankeman/public/../application/index/view/index/case.html";i:1563865288;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	    ...
	    <script type="text/javascript" src="static/index/js/case.js" ></script>
	...
	<body >
		...
		<div class="case-btn-list">
			<div class="btn-list">
				<a class="btn-prev" href="javascript:void(null)" onclick="minPageNum()">上一页</a>
				<div id="pagebox">
					
				</div>				
				<a class="btn-next" href="javascript:void(null)" onclick="addPageNum()">下一页</a>
				<a class="btn-first" href="javascript:void(null)">首页</a>
				<a class="btn-last" href="javascript:void(null)">尾页</a>
				<input class="btn-number" type="number" name="" id="" value="" />
				<a class="btn-go" href="javascript:void(null)" onclick="pagego()">跳转</a>
			</div>
		</div>
		<div class="footer">
			<div class="box">

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Product\Servicestandards.html";i:1567671857;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div class="form-group has-feedback">
                    <label class="col-lg-3 control-label">服务<?php echo $vo['id']; ?>：</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" name="standards<?php echo $vo['id']; ?>" value="<?php echo $vo['content']; ?>" placeholder="" data-bv-field="name">
...
<script>
    $(function(){
        $('#CreateSubmit').click(function(){
            ...
            var standards1 = $("input[name='standards1']").val();
            var standards2 = $("input[name='standards2']").val();
            var standards3 = $("input[name='standards3']").val();
            var standards4 = $("input[name='standards4']").val();
            var standards5 = $("input[name='standards5']").val();
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (data.code == 1) {
                        ...
                        setTimeout(function(){
                            window.location.href='/Admin/Servicestandards';
                        },1500);
                    }else{
                        layer.msg(data.meg, function(){
                            //关闭后的操作

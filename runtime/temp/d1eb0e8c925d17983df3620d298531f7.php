<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Question\editbanner.html";i:1567755077;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<script>
  $(function(){
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Question/bannerupdate',
          data: {
		    id:id,
            title:title,
          },

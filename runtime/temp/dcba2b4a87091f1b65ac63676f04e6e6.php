<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Banner\update.html";i:1567671860;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
			  ...
			  <div class="form-group has-feedback">
				...
				<div class="col-lg-7">
				  <input type="text" class="form-control" name="banner_name" placeholder="标题" data-bv-field="name" value="<?php echo $con['banner_name']; ?>">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-lg-7">
                    <input type="text" class="form-control" name="display" placeholder="" data-bv-field="name" value="<?php echo $con['display']; ?>">
                    <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
                </div>
            </div>
			 <div class="form-group has-feedback">
				...
				<div class="col-lg-4">
				  <img src="<?php echo $con['banner_img']; ?>" alt="" style="width: 150px;height: 120px;">
				</div>
			  </div> 

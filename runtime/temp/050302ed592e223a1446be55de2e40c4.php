<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Banner\index.html";i:1567671860;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div id="demo-custom-toolbar2" class="table-toolbar-left">
        <a href="/Admin/Banner/add" id="demo-dt-addrow-btn" class="btn btn-primary"><i class="demo-pli-plus"></i> 添加</a> 
        <div class="col-m-5">
        </div>
    </div>
        ...
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><img src="__ROOT__<?php echo $vo['banner_img']; ?>" style="width: 200px;"></td>
                    <td>
                        <?php if($vo['display'] == '1'): ?> 显示 <?php else: ?> 隐藏 <?php endif; ?>
                    </td>
					<td><?php echo date("Y-m-d",$vo['addtime']); ?></td>
					<td>
                    	<a href="/Admin/Banner/update/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>

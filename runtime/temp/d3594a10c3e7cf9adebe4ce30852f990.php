<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Administrator\update.html";i:1567671861;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="username" value="<?php echo $update['username']; ?>" placeholder="用户名" data-bv-field="name">
                ...
                <div class="checkbox">
                	 <div class="col-lg-7">
	                	<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                		<li style="list-style-type:decimal"><input name="role" <?php if(in_array($vo['id'],explode(',',$update['role']))){ echo 'checked';} ?> value="<?php echo $vo['id']; ?>" type="checkbox" ><span><?php echo $vo['name']; ?></span></li>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="email" class="form-control" name="nickname" value="<?php echo $update['nickname']; ?>" placeholder="昵称" data-bv-field="email">
...
<script>
  $(function(){
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Administrator/DoUpdate?id=<?php echo $update['id']; ?>',
          data: {
            username:username,
            password:password,
            nickname:nickname,

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\PHPTutorial\WWW\ankeman\public/../application/index\view\index\problem.html";i:1568707593;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="box">
				<div class="problem-tab-box">
					<div class="problem-tab">
						<?php echo (isset($data[0]['title']) && ($data[0]['title'] !== '')?$data[0]['title']:"暂无"); ?>
					</div>
				</div>
				<div class="problem-tab-box p-l p-r">
					<div class="problem-tab">
						<?php echo (isset($data[1]['title']) && ($data[1]['title'] !== '')?$data[1]['title']:"暂无"); ?>

					</div>
				</div>
				<div class="problem-tab-box">
					<div class="problem-tab">
						<?php echo (isset($data[2]['title']) && ($data[2]['title'] !== '')?$data[2]['title']:"暂无"); ?>
					</div>
				</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/home/wwwroot/default/ankeman/public/../application/admin/view/Project/details_list.html";i:1563941998;s:79:"/home/wwwroot/default/ankeman/public/../application/admin/view/Public/base.html";i:1563948980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div id="demo-custom-toolbar2" class="table-toolbar-left">
        <a href="/Admin/Project_details_add" id="demo-dt-addrow-btn" class="btn btn-primary"><i class="demo-pli-plus"></i> 添加</a> 
        <div class="col-m-5">
        </div>
    </div>
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
               <?php if(is_array($details_list) || $details_list instanceof \think\Collection || $details_list instanceof \think\Paginator): $i = 0; $__LIST__ = $details_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
					...
					<td>
                    	<a href="/Admin/Project_details_update/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
						<!--<a href="/Admin/Project_details/<?php echo $vo['id']; ?>" class="btn btn-xs DeleteSubmit btn-rounded Delete btn-danger">查看</a>-->
        ...
        <div>
             <tr class="content">
                <td colspan="3" bgcolor="#FFFFFF"><?php echo $details_list->render(); ?><div class="pages">
...
<script>
    $(function(){
        $('.DeleteSubmit').click(function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/Admin/Project/details_delete',
                data: {
                    id:id,
                },

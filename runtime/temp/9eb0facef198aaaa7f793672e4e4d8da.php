<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Article\index.html";i:1567760455;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div id="demo-custom-toolbar2" class="table-toolbar-left">
        <a href="/Admin/Article/add" id="demo-dt-addrow-btn" class="btn btn-primary"><i class="demo-pli-plus"></i> 添加</a>
        <div class="col-m-5">
        </div>
    </div>
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                <tr>
					...
					<td>
                    	<a href="/Admin/Article/edit?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>

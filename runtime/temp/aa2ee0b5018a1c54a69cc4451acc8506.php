<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Service\Service_nav_update.html";i:1567671860;s:76:"E:\PHPTutorial\WWW\ankeman\public/../application/admin\view\Public\base.html";i:1567676542;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="" method="POST" novalidate="novalidate">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">导航</label>
            <div class="col-lg-7">
              <input type="text" class="form-control" name="title" placeholder="导航" value="<?php echo $list['title']; ?>" data-bv-field="name">
    ...
    <div class="panel-footer clearfix">
      <div class="col-lg-7 col-lg-offset-3">
        <button type="button" class="btn btn-mint" id="CreateSubmit" value="点击创建">点击修改</button></div>
    </div>
  </form>
</div>
<script>
